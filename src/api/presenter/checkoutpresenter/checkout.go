...
var (
	...
	paymentMethodNotImplemented = "payment_method.not_implemented"
	...
	message = map[string]string{
		...
		paymentMethodNotImplemented: "Metode pembayaran belum bisa digunakan",
	}
	...
	systemCode = map[string]string{
		...
		paymentMethodNotImplemented: "62",
		bodyPayload:                 "80",
		queryFind:                   "81",
		queryInsert:                 "82",
		queryUpdate:                 "83",
	...
	statusCode = map[string]int{
		...
		paymentMethodNotImplemented: http.StatusBadRequest,
	}
)
