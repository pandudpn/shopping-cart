...
import (
	...
	"github.com/pandudpn/shopping-cart/src/repository/cartrepo"
)

type cartRepositoryFactory struct{}

func (crf *cartRepositoryFactory) Build(c container.Container) (RepositoryFactoryInterface, error) {
	code := constant.PSQL
	...
	db := dsfi.(dbc.SqlDbc)
	cr := cartrepo.CartRepository{DB: db}
