...
import (
	...
	"github.com/pandudpn/shopping-cart/src/domain/usecase/checkoutusecase"
	"github.com/pandudpn/shopping-cart/src/repository"
)

type checkoutUseCaseFactory struct{}

func (cuuf *checkoutUseCaseFactory) Build(c container.Container) (UseCaseFactoryInterface, error) {
	// CART REPOSITORY
	code := constant.CART
